...
public class NewIndexActivity extends FunctionActivity implements AddPersonWindow.OptionTypeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        alert_password.PasswordViewInit(new Alert_Password.Callback() {
            ...
            public void normal_call() {
                personWindow = new AddPersonWindow(NewIndexActivity.this);
                personWindow.setOptionTypeListener(NewIndexActivity.this);
    ...
    void openService() {
        intent = new Intent(NewIndexActivity.this, SwitchService.class);
        startService(intent);
    }
    ...
    public void onOptionType(Button view, int type) {
        ...
        if (type == 1) {
            ...
            new AlertView("设备信息同步", null, "取消", new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
            ...
            new AlertView("删除人员指纹信息", null, "取消", new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
                public void onItemClick(Object o, int position) {
                    if (position == 0) {
    ...
    public void onFpSucc(final String msg) {
        Alarm.getInstance(this).doorAlarm(new Alarm.doorCallback() {
            ...
            @Override
            public void onSucc() {
                Alarm.getInstance(NewIndexActivity.this).networkAlarm(network_state, new Alarm.networkCallback() {
                    @Override
...
//        loadMessage(msg.substring(3, msg.length()));
        ...
        if (alert_message.Showing()) {
            ...
            Alarm.getInstance(NewIndexActivity.this).networkAlarm(network_state, new Alarm.networkCallback() {
                ...
                public void onIsKnown() {
                    ...
                    } else if (courTypes.getString(cardInfo.cardId()).contains(PersonType.XunJian)) {
                        if (checkChange != null) {
                            checkChange.dispose();
                        }
                        cg_User1.setName(cardInfo.name());
                    ...
                    } else if (courTypes.getString(cardInfo.cardId()).equals(PersonType.Gongan)) {
                        if (checkChange != null) {
                            checkChange.dispose();
                        }
                        cg_User1.setName(cardInfo.name());
    ...
    private void OpenDoorRecord(boolean leagl) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(NewIndexActivity.this);
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            if (infoMap.get("result") == null) {
                                ...
                                new AlertView("设备数据更新成功", null, null, new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                    @Override
                                    public void onItemClick(Object o, int position) {
                                        fpp.fpIdentify();
                                    }
                               ...
                               /* if(infoMap.get("result").equals("dataErr")){
                                    new AlertView("验证失败", null, null, new String[]{"确定"}, null, IndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                        @Override
                                        public void onItemClick(Object o, int position) {
                                    ...
                                    new AlertView("数据库操作有错", null, null, new String[]{"确定"}, null, IndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                        @Override
                                        public void onItemClick(Object o, int position) {

                                        }
                                    }).show();
                                }else if(infoMap.get("result").equals("notSameCompany")){
                                    new AlertView("新设备和之前的设备不属于同一企业", null, null, new String[]{"确定"}, null, IndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                        @Override
                                        public void onItemClick(Object o, int position) {

                                        }
                                    }).show();
                                }else if(infoMap.get("result").equals("oldDaidnull")){
                                    new AlertView("原设备号为空", null, null, new String[]{"确定"}, null, IndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                        @Override
                                        public void onItemClick(Object o, int position) {
                                    ...
                                    new AlertView("新设备与库房未绑定", null, null, new String[]{"确定"}, null, IndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                        @Override
                                        public void onItemClick(Object o, int position) {
                                ...
                                new AlertView("设备号有误", null, null, new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                    @Override
                                    public void onItemClick(Object o, int position) {
    ...
    private void checkRecord(String type) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(NewIndexActivity.this);
        RetrofitGenerator.getConnectApi().checkRecord(config.getString("key"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
    ...
    private void unknownPeople(Bitmap bmp) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(NewIndexActivity.this);
        RetrofitGenerator.getConnectApi().saveVisit(config.getString("key"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            if (infoMap.get("result").equals("true")) {
                                ...
                                new AlertView("删除失败", null, null, new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                    @Override
                                    public void onItemClick(Object o, int position) {
                                ...
                                new AlertView("服务出错", null, null, new String[]{"确定"}, null, NewIndexActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                                    @Override
                                    public void onItemClick(Object o, int position) {
